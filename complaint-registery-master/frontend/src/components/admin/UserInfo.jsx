      ...
      if (updateUser .name === "" && updateUser .email === "" && updateUser .phone === "") {
         ...
         if (confirmed) {
            try {
               ...
               setUpdateUser ({ name: '', email: '', phone: '' }); // Reset form
            } catch (err) {
               console.log(err);
            }
         }
                           ...
                           return (
                              <tr key={user._id}>
                                 ...
                                 <td>
                                    ...
                                    <Collapse in={open}>
                                       <Form onSubmit={(e) => { e.preventDefault(); handleSubmit(user._id); }} className='p-3'>
                                    ...
                                    <Button onClick={() => deleteUser (user._id)} className='mx-2' variant="outline-danger">Delete</Button>
                                 </td>
                              </tr>
                           );
                        })
